...
public class Identify {
	...
	private String caseFolderPath = null;  // E:\BaiduYunDownload\shuffledCase\geneScoreMatrix        recessive_model folder in this path, then the frequencies folder.
	...
	public static void main(String[] args) {
		...
		try{
			frequencyFileReader = new BufferedReader(new FileReader(identify.getToBeShuffledFrequencyFilePath()));
	...
	public void runRscrpt(String rscriptFilePath, String frequency){
		try {
			...
			String resultPath = new File(rscriptFilePath).getParent() + File.separator + this.getInheritanceModel() + "_" + frequency +".txt";
	...
	public void convertRawoutToReadable(String rawoutFilePath, String frequency) {
		...
		String readableFilePath = new File(rawoutFilePath).getParent() + File.separator
									+ frequency + "_" + this.getInheritanceModel() + ".txt";
