...
public class Score {
      ...
      for (String fileItem : fileList) {
        ...
        try {
          ...
          while ((tempString = bReader.readLine()) != null) {
            ...
            /** calculate average. */
            double averageScore =
              countAverage(Arrays.asList(feature[6], feature[9], feature[13], feature[15]));
        ...
        System.out.println(
          fileItem + " got variants' average score at " + averageScoreFile.getCanonicalPath()
            + " !");
      }
   ...
   */
  public void scoreEachGene(String samplesFolderPath, String caseOrControl, String inheritanceModel,
    String outputPath, int column) {
    try {
      ...
      for (String fileItemName : fileList) {
        System.out.println(
          "scoreEachGene: processing " + samplesFolderPath + File.separator + fileItemName);
        ...
        try {
          bReader =
            new BufferedReader(new FileReader(samplesFolderPath + File.separator + fileItemName));
  ...
  public String getGeneScoreRecessiveModel(List<String> list) {
    ...
    DecimalFormat dFormat = new DecimalFormat("#####0.000000");
    if (list.get(list.size() - 1).trim().equals(".") || list.get(list.size() - 2).trim()
      .equals("."))
      return "N/A";
    double sum =
      Double.parseDouble(list.get(list.size() - 1)) + Double.parseDouble(list.get(list.size() - 2));
